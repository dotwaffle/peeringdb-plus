...
# (allow_ixp_update, ixp_update_exclude, social_media). This is the source the
# extractor reads for the concrete model shape; django-peeringdb's own
# concrete.py is not used.
