...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			carrierfacility.Table:  carrierfacility.ValidColumn,
			facility.Table:         facility.ValidColumn,
			internetexchange.Table: internetexchange.ValidColumn,
			ixfacility.Table:       ixfacility.ValidColumn,
			ixlan.Table:            ixlan.ValidColumn,
			ixprefix.Table:         ixprefix.ValidColumn,
			network.Table:          network.ValidColumn,
			networkfacility.Table:  networkfacility.ValidColumn,
			networkixlan.Table:     networkixlan.ValidColumn,
			organization.Table:     organization.ValidColumn,
			poc.Table:              poc.ValidColumn,
		})
	})
