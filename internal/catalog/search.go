...
var searchTypes = []searchTypeConfig{
	{typeName: "Networks", typeSlug: "net", fields: []string{"name", "aka", "name_long", "irr_as_set"}},
	{typeName: "IXPs", typeSlug: "ix", fields: []string{"name", "aka", "name_long", "city", "country"}},
	{typeName: "Facilities", typeSlug: "fac", fields: []string{"name", "aka", "name_long", "city", "country"}},
	{typeName: "Organizations", typeSlug: "org", fields: []string{"name", "aka", "name_long"}},
	{typeName: "Campuses", typeSlug: "campus", fields: []string{"name"}},
	{typeName: "Carriers", typeSlug: "carrier", fields: []string{"name", "aka", "name_long"}},
}
