...
// annotations_test.go, the traversal parser) keep compiling unchanged.
...
// Path A allowlist annotations. Re-exports
...
// constructor for FILTER_EXCLUDE annotations. Re-exports
// schemaannot.WithFilterExcludeFromTraversal.
//
// Initial expected call sites:
...
// deep (>2 separators — exceed the 2-hop cap, so codegen drops them
