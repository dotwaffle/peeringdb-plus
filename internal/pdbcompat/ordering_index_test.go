...
// status='ok' on every type except netixlan, and applyStatusMatrix emits an
// equality for it). All 13 entities carry the same generated index; networks
// is the representative case. Without the index the planner uses the
