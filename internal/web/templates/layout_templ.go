...
func Layout(opts LayoutOptions, contents templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, " - PeeringDB Plus</title><link rel=\"icon\" type=\"image/svg+xml\" href=\"/static/favicon.svg\"><link rel=\"icon\" type=\"image/x-icon\" href=\"/static/favicon.ico\"><script>\n\t\t\t(function(){\n\t\t\t\tvar d=document.documentElement;\n\t\t\t\tvar t=localStorage.getItem('darkMode');\n\t\t\t\tif(t==='dark'||(t!=='light'&&window.matchMedia('(prefers-color-scheme:dark)').matches)){\n\t\t\t\t\td.classList.add('dark');\n\t\t\t\t}\n\t\t\t})();\n\t\t\t</script><link rel=\"stylesheet\" href=\"/static/tailwind.css\"><link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/flag-icons@7.5.0/css/flag-icons.min.css\"><script src=\"/static/htmx.min.js\"></script>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if opts.NeedsMap {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<main class=\"flex-1 container mx-auto px-4 py-8\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
