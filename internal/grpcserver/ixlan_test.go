...
// TestIxLanToProto_FieldPrivacy is the unit-level ConnectRPC field-privacy
...
// the _visible companion populated. Cover both tier branches plus
// the fail-closed un-stamped ctx path.
//
...
func TestIxLanToProto_FieldPrivacy(t *testing.T) {
	...
	// _visible companion STILL populated.
