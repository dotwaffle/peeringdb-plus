...
| PARITY-01 | 72 | in progress (72-01 foundation + 72-02 STATUS+LIMIT + 72-03 UNICODE+IN+TRAVERSAL: cmd/pdb-fixture-port/ extended with parse_unicode.go + parse_in.go + parse_traversal.go siblings + main.go --upstream-commit override flag + parse_status.go findFirstSubstringLine helper extraction; internal/testutil/parity/fixtures.go regenerated to 5560 fixtures across all 6 vars at SAME pinned upstream peeringdb/peeringdb@99e92c72: 12 ord + 46 status + 270 limit BYTE-IDENTICAL to 72-02 commit cca6c3c (block-extract diff verified) + 216 unicode (6 entities × 4 fields × 9 samples — diacritic/CJK/Greek/combining-mark) + 5002 in (5001 contig 100000..105000 for IN-01 SQLite-999-var boundary + 999999 sentinel for IN-02 empty-__in) + 14 traversal (ring topology with __hop=2 marker + silent-ignore probe for TRAVERSAL-04); 4 new parity sanity tests in fixtures_test.go (UnicodeFixtures_Sanity ≥32+diacritic+CJK, InFixtures_LargeContiguousBlock 100000..105000+sentinel, TraversalFixtures_RingAndSilentIgnore __hop=2+silent-ignore, AllFixtures_NoDuplicateIDsWithinCategoryAllSix); 6 new cmd tests; plans 72-04..06 remaining for consumer test suite + benchmarks + docs close) |
