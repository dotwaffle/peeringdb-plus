...
| PARITY-01 | 72 | in progress (72-01 foundation + 72-02 STATUS+LIMIT: cmd/pdb-fixture-port/ extended with parse_status.go + parse_limit.go + section{}-based multi-section render + --append + --category all + extractFieldsSharp; internal/testutil/parity/fixtures.go regenerated to 328 fixtures (12 ord byte-identical + 46 status w/ campus-pending carve-out + 270 limit w/ ≥260 net for LIMIT-01 boundary) at SAME pinned upstream peeringdb/peeringdb@99e92c72; 6 fixtures sanity tests in fixtures_test.go incl. TestStatusFixtures_CampusPendingCarveOut + TestLimitFixtures_NonEmptyAndBoundary + TestAllFixtures_NoDuplicateIDsWithinCategory; plans 72-03..06 remaining) |
