...
- [x] **Phase 21: Infrastructure** - Remove LiteFS proxy, implement fly-replay write forwarding, enable h2c (completed 2026-03-25)
- [x] **Phase 22: Proto Generation Pipeline** - Annotate 13 ent schemas, configure buf toolchain, generate protos and ConnectRPC interfaces (completed 2026-03-25)
- [x] **Phase 23: ConnectRPC Services** - Get/List RPCs for all 13 types with observability, reflection, and health checking (completed 2026-03-25)
- [x] **Phase 24: List Filtering** - Typed filter fields on List RPCs for querying across all 13 types (completed 2026-03-25)
...
Plans:
- [ ] 21-01-PLAN.md -- Remove LiteFS proxy, fix fly-replay, enable h2c
...
Plans:
- [x] 22-01-PLAN.md -- Toolchain setup: tool deps, buf config, common.proto, entproto extension in entc.go
- [x] 22-02-PLAN.md -- Annotate all 13 schemas, run generation pipeline, verify compilation
- [ ] 22-03-PLAN.md -- Gap closure: Add service definitions and generate ConnectRPC handler interfaces
...
Plans:
- [x] 23-01-PLAN.md -- Conversion helpers, pagination, NetworkService template with tests
- [x] 23-02-PLAN.md -- Remaining 12 service handler implementations
- [x] 23-03-PLAN.md -- CORS update, service registration, otelconnect, reflection, health check
...
Plans:
- [x] 24-01-PLAN.md -- Proto filter fields for all 13 types, buf regeneration, Network filter implementation with tests
- [x] 24-02-PLAN.md -- Filter logic for remaining 12 handlers with representative tests
...
| 21. Infrastructure | v1.6 | 0/1 | Complete    | 2026-03-25 |
| 22. Proto Generation Pipeline | v1.6 | 2/3 | Complete    | 2026-03-25 |
| 23. ConnectRPC Services | v1.6 | 3/3 | Complete    | 2026-03-25 |
| 24. List Filtering | v1.6 | 2/2 | Complete    | 2026-03-25 |
