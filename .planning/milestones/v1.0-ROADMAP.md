...
Plans:
- [x] 01-01-PLAN.md — Project scaffolding, Go module, entgo foundation, SQLite setup
- [x] 01-02-PLAN.md — All 13 entgo schemas with fields, edges, indexes, annotations, OTel mutation hooks
- [x] 01-03-PLAN.md — PeeringDB API client with rate limiting, pagination, retry
- [x] 01-04-PLAN.md — Sync worker: upsert, delete, status tracking, retry with backoff, scheduling
- [x] 01-05-PLAN.md — Schema extraction pipeline (Django source parser + entgo generator)
- [x] 01-06-PLAN.md — Application wiring: main binary and Dockerfile
- [x] 01-07-PLAN.md — Test fixtures and fixture-based integration tests
...
Plans:
- [x] 02-01-PLAN.md — Fix schema annotations for Relay spec, regenerate ent code, scaffold gqlgen resolvers
- [x] 02-02-PLAN.md — Implement all resolvers: ent queries, DataLoader, global IDs, syncStatus, networkByAsn
- [x] 02-03-PLAN.md — HTTP middleware (CORS, logging, recovery), GraphQL handler factory, config extensions
- [ ] 02-04-PLAN.md — Wire GraphQL into main.go, export SDL, integration tests for full API surface
...
Plans:
- [x] 03-01-PLAN.md — OTel foundation: TracerProvider, MeterProvider, LoggerProvider via autoexport, dual slog logger, custom sync metrics, config extensions
- [x] 03-02-PLAN.md — Health/readiness endpoints with sync freshness, LiteFS primary detection
- [ ] 03-03-PLAN.md — Wire OTel + health + LiteFS into main.go, otelhttp middleware, deployment artifacts (Dockerfile.prod, litefs.yml, fly.toml)
...
| 2. GraphQL API | 0/4 | Planning complete | - |
| 3. Production Readiness | 0/3 | Planning complete | - |
