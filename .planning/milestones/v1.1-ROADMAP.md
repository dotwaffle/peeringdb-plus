...
Plans:
- [ ] 04-01-PLAN.md — HTTP client tracing with otelhttp transport and manual span hierarchy
- [ ] 04-02-PLAN.md — Sync metric instruments registration and recording wiring
...
Plans:
- [x] 05-01-PLAN.md — Install entrest, configure dual codegen extension, annotate all 13 schemas + edges
- [x] 05-02-PLAN.md — Mount REST handler on server, integration tests for all REST requirements
- [ ] 05-03-PLAN.md — Gap closure: add per-field filtering via entrest.WithFilter annotations + tests
...
Plans:
- [x] 06-01-PLAN.md — Type registry, filter parser, serializers, and response envelope
- [x] 06-02-PLAN.md — HTTP handlers (list, detail, index), pagination, since, server wiring
- [ ] 06-03-PLAN.md — Depth expansion, search (?q=), and field projection (?fields=)
...
| 4. Observability Foundations | v1.1 | 0/2 | Not started | - |
| 5. entrest REST API | v1.1 | 2/3 | In progress | - |
| 6. PeeringDB Compatibility Layer | v1.1 | 0/3 | Not started | - |
