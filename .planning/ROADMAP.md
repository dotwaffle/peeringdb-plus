...
Plans:
- [ ] 33-01-PLAN.md -- Proto filter parity (add ~96 optional fields to services.proto) + middleware test coverage
- [ ] 33-02-PLAN.md -- Generic ListEntities/StreamEntities helpers + refactor all 13 handler files with full filter functions
...
| 33. gRPC Deduplication & Filter Parity | 0/3 | Not started | - |
