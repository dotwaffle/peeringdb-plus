...
- [ ] 41-02-PLAN.md -- internal/otel, internal/health, internal/peeringdb error path and edge case coverage to 90%+
...
| 41. Schema & Minor Package Coverage | 0/2 | Not started | - |
