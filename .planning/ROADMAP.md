...
**Plans:** 6 plans
- [ ] 59-01-PLAN.md — internal/privctx package (Tier type, WithTier, TierFrom) (Wave 1)
- [ ] 59-02-PLAN.md — PDBPLUS_PUBLIC_TIER env parser + Config field + validator (Wave 2)
- [ ] 59-03-PLAN.md — PrivacyTier HTTP middleware + chain wiring + chain-order regression test (Wave 3)
- [ ] 59-04-PLAN.md — FeaturePrivacy codegen + POC Policy() + VIS-04 behaviour tests (Wave 4)
...
| 59. ent Privacy policy + sync bypass | 0/6 | In progress | - |
